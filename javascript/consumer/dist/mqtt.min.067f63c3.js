...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/mqtt.min.js":[function(require,module,exports) {
var define;
  ...
  return function () {
        ...
        (function () {
          ...
          function v(e, t) {
            ...
            for (r in this.options = t || {}, g) {
              void 0 === this.options[r] ? this.options[r] = g[r] : this.options[r] = t[r];
            }
            ...
            h("MqttClient :: options.protocol", t.protocol), h("MqttClient :: options.protocolVersion", t.protocolVersion), h("MqttClient :: options.username", t.username), h("MqttClient :: options.keepalive", t.keepalive), h("MqttClient :: options.reconnectPeriod", t.reconnectPeriod), h("MqttClient :: options.rejectUnauthorized", t.rejectUnauthorized), this.options.clientId = "string" == typeof t.clientId ? t.clientId : "mqttjs_" + Math.random().toString(16).substr(2, 8), h("MqttClient :: clientId", this.options.clientId), this.options.customHandleAcks = 5 === t.protocolVersion && t.customHandleAcks ? t.customHandleAcks : function () {
              ...
              h("connect :: sending queued packets"), function t() {
                ...
                h("deliver :: entry %o", r);
                var i;
                r && (i = r.packet, h("deliver :: call _sendPacket for %o", i), n._sendPacket(i, function (e) {
                  r.cb && r.cb(e), t();
                }));
              }();
          ...
          u(v, i), v.prototype._setupStream = function () {
            ...
            function c() {
              ...
              var e = o.shift();
              if (e) h("work :: packet pulled from queue"), t._handlePacket(e, u);else {
            ...
            if (h("_setupStream :: calling method to clear reconnect"), this._clearReconnect(), h("_setupStream :: using streamBuilder provided to client to create stream"), this.stream = this.streamBuilder(this), n.on("packet", function (e) {
              ...
              if (this.options.properties.authenticationMethod && this.options.authPacket && "object" == _typeof(this.options.authPacket)) y(this, f({
                cmd: "auth",
                reasonCode: 0
            ...
            if (5 === p && (g.nl = !1, g.rap = !1, g.rh = 0), u = f(g, u), Array.isArray(o) ? o.forEach(function (e) {
              ...
              return this.outgoing[e.messageId] = {
                volatile: !0,
                cb: function cb(e, t) {
                  if (!e) for (var r = t.granted, n = 0; n < r.length; n += 1) {
                    i[n].qos = r[n];
                  }
                  a(e, i);
                }
            ...
            var i = r.shift(),
                o = r.pop() || w,
                s = r.pop();
            return "string" == typeof i && (i = [i]), "function" != typeof o && (s = o, o = w), this._checkDisconnecting(o) ? this : ("string" == typeof i ? e.unsubscriptions = [i] : Array.isArray(i) && (e.unsubscriptions = i), this.options.resubscribe && e.unsubscriptions.forEach(function (e) {
              delete t._resubscribeTopics[e];
            }), "object" == _typeof(s) && s.properties && (e.properties = s.properties), this.outgoing[e.messageId] = {
              volatile: !0,
              cb: o
            ...
            function i() {
              h("end :: (%s) :: finish :: calling _cleanUp with force %s", n.options.clientId, e), n._cleanUp(e, function () {
                  ...
                  h("end :: closeStores: closing incoming and outgoing stores"), n.disconnected = !0, n.incomingStore.close(function (e) {
                    n.outgoingStore.close(function (t) {
                      if (h("end :: closeStores: emitting end"), n.emit("end"), r) {
                        ...
                        h("end :: closeStores: invoking callback with args"), r(_n);
                      }
                    });
            ...
            h("_reconnect: emitting reconnect to client"), this.emit("reconnect"), this.connected ? (this.end(function () {
              _this2._setupStream();
            ...
            if (!this._firstConnection && (this.options.clean || 5 === this.options.protocolVersion && !e.sessionPresent) && t.length > 0) if (this.options.resubscribe) {
    ...
    5: [function (e, t, r) {
      (function (r, n) {
        (function () {
          ...
          var u = ["rejectUnauthorized", "ca", "cert", "key", "pfx", "passphrase"];
          var c = void 0 !== r && "browser" === r.title || "function" == typeof __webpack_require__;
          ...
          t.exports = c ? function (e, t) {
            ...
            var i = function (e) {
              ...
              if (t.hostname || (t.hostname = t.host), !t.hostname) {
                ...
                var _e = new URL(document.URL);

                t.hostname = _e.hostname, t.port || (t.port = _e.port);
              }
            ...
            t.objectMode || (p._writev = _), p.on("close", function () {
              h.close();
            });
            var d = void 0 === h.addEventListener;
            ...
            function _(e, t) {
              ...
              for (var _t = 0; _t < e.length; _t++) {
                "string" == typeof e[_t].chunk ? r[_t] = n.from(e[_t], "utf8") : r[_t] = e[_t].chunk;
              }
    ...
    10: [function (e, t, r) {
      ...
      r.byteLength = function (e) {
        ...
        for (r = 0; r < f; r += 4) {
          t = i[e.charCodeAt(r)] << 18 | i[e.charCodeAt(r + 1)] << 12 | i[e.charCodeAt(r + 2)] << 6 | i[e.charCodeAt(r + 3)], u[l++] = t >> 16 & 255, u[l++] = t >> 8 & 255, u[l++] = 255 & t;
        }
    ...
    11: [function (e, t, r) {
      ...
      o._init = function (e) {
        ...
        for (var _r = 0; _r < this._bufs.length; _r++) {
          var _n2 = t + this._bufs[_r].length;

          if (e < _n2 || _r === this._bufs.length - 1) return [_r, e - t];
          t = _n2;
        }
        ...
        for (var _e3 = 0; _e3 < t; _e3++) {
          r += this._bufs[_e3].length;
        }
        ...
        if (0 === r && i === this.length) {
          ...
          for (var _t2 = 0; _t2 < this._bufs.length; _t2++) {
            this._bufs[_t2].copy(e, c), c += this._bufs[_t2].length;
          }
        ...
        for (var _t3 = s[0]; _t3 < this._bufs.length; _t3++) {
          var _r2 = this._bufs[_t3].length - l;

          if (!(u > _r2)) {
            this._bufs[_t3].copy(e, c, l, l + u), c += _r2;
            break;
          }

          this._bufs[_t3].copy(e, c, l), c += _r2, u -= _r2, l && (l = 0);
        }
        ...
        for (var _t4 = 0; _t4 < this._bufs.length; _t4++) {
          e.append(this._bufs[_t4]);
        }

        return e;
      }, o.prototype.append = function (e) {
        if (null == e) return this;
        if (e.buffer) this._appendBuffer(n.from(e.buffer, e.byteOffset, e.byteLength));else if (Array.isArray(e)) for (var _t5 = 0; _t5 < e.length; _t5++) {
          this.append(e[_t5]);
        } else if (this._isBufferList(e)) for (var _t6 = 0; _t6 < e._bufs.length; _t6++) {
          this.append(e._bufs[_t6]);
        ...
        for (; o < this._bufs.length; o++) {
          var _t7 = this._bufs[o];

          for (; s < _t7.length;) {
            if (_t7.length - s >= e.length) {
              var _r3 = _t7.indexOf(e, s);

              if (-1 !== _r3) return this._reverseOffset([o, _r3]);
              s = _t7.length - e.length + 1;
            } else {
              var _t8 = this._reverseOffset([o, s]);

              if (this._match(_t8, e)) return _t8;
              s++;
            }
          }
        ...
        for (var _r4 = 0; _r4 < t.length; _r4++) {
          if (this.get(e + _r4) !== t[_r4]) return !1;
        }
      ...
      (function (t) {
        (function () {
          ...
          r.kMaxLength = i, s.TYPED_ARRAY_SUPPORT = function () {
            ...
            for (var o = i - n, a = r - t, u = Math.min(o, a), c = this.slice(n, i), l = e.slice(t, r), f = 0; f < u; ++f) {
              if (c[f] !== l[f]) {
                o = c[f], a = l[f];
                break;
              }
          ...
          function O(e, t, r, i, o) {
            return t = +t, r >>>= 0, o || M(e, 0, r, 4), n.write(e, t, r, i, 23, 4), r + 4;
          }

          function P(e, t, r, i, o) {
            return t = +t, r >>>= 0, o || M(e, 0, r, 8), n.write(e, t, r, i, 52, 8), r + 8;
          }
          ...
          s.prototype.slice = function (e, t) {
            ...
            var i = n - r;
            if (this === e && "function" == typeof Uint8Array.prototype.copyWithin) this.copyWithin(t, r, n);else if (this === e && r < t && t < n) for (var o = i - 1; o >= 0; --o) {
              e[o + t] = this[o + r];
    ...
    17: [function (e, t, r) {
      t.exports = function (t) {
        function r(e) {
          ...
          return o.namespace = e, o.useColors = r.useColors(), o.color = r.selectColor(e), o.extend = n, o.destroy = r.destroy, Object.defineProperty(o, "enabled", {
            enumerable: !0,
            configurable: !1,
            get: function get() {
              return null === i ? r.enabled(e) : i;
            },
            set: function set(e) {
              i = e;
            }
          }), "function" == typeof r.init && r.init(o), o;
        }
    ...
    21: [function (e, t, r) {
      (function (r, n) {
        (function () {
          ...
          function v(e, t, r, n) {
            t.flowing && 0 === t.length && !t.sync ? (e.emit("data", r), e.read(0)) : (t.length += t.objectMode ? 1 : r.length, n ? t.buffer.unshift(r) : t.buffer.push(r), t.needReadable && k(e)), C(e, t);
          }
          ...
          _.prototype.read = function (e) {
            ...
            var t = this._readableState,
                r = e;
            if (0 !== e && (t.emittedReadable = !1), 0 === e && t.needReadable && (t.length >= t.highWaterMark || t.ended)) return p("read: emitReadable", t.length, t.ended), 0 === t.length && t.ended ? O(this) : k(this), null;
            ...
            var u = (!t || !1 !== t.end) && e !== r.stdout && e !== r.stderr ? l : _;

            function c(t, r) {
              p("onunpipe"), t === n && r && !1 === r.hasUnpiped && (r.hasUnpiped = !0, p("cleanup"), e.removeListener("close", m), e.removeListener("finish", y), e.removeListener("drain", f), e.removeListener("error", b), e.removeListener("unpipe", c), n.removeListener("end", l), n.removeListener("end", _), n.removeListener("data", g), h = !0, !o.awaitDrain || e._writableState && !e._writableState.needDrain || f());
            }
            ...
            function g(t) {
              p("ondata"), d = !1, !1 !== e.write(t) || d || ((1 === o.pipesCount && o.pipes === e || o.pipesCount > 1 && -1 !== B(o.pipes, e)) && !h && (p("false write response, pause", n._readableState.awaitDrain), n._readableState.awaitDrain++, d = !0), n.pause());
            }

            function b(t) {
              p("onerror", t), _(), e.removeListener("error", b), 0 === a(e, "error") && e.emit("error", t);
            }
            ...
            function y() {
              p("onfinish"), e.removeListener("close", m), _();
            }
            ...
            }(e, "error", b), e.once("close", m), e.once("finish", y), e.emit("pipe", n), o.flowing || (p("pipe resume"), n.resume()), e;
    ...
    23: [function (e, t, r) {
      (function (r, n, i) {
        (function () {
          ...
          t.exports = y;
          var a,
              u = !r.browser && ["v0.10", "v0.9."].indexOf(r.version.slice(0, 5)) > -1 ? i : o.nextTick;
          y.WritableState = m;
          ...
          c.inherits(y, f), m.prototype.getBuffer = function () {
            ...
            "function" == typeof e ? (r = e, e = null, t = null) : "function" == typeof t && (r = t, t = null), null !== e && void 0 !== e && this.write(e, t), n.corked && (n.corked = 1, this.uncork()), n.ending || n.finished || function (e, t, r) {
              t.ending = !0, k(e, t), r && (t.finished ? o.nextTick(r) : e.once("finish", r));
      ...
      (function (r) {
        (function () {
          var n = e("once"),
            ...
            }(e) ? l && !a && (e.on("end", h), e.on("close", h)) : (e.on("complete", p), e.on("abort", m), e.req ? _() : e.on("request", _)), function (e) {
              return e.stdio && Array.isArray(e.stdio) && 3 === e.stdio.length;
            }(e) && e.on("exit", g), e.on("end", d), e.on("finish", p), !1 !== t.error && e.on("error", b), e.on("close", m), function () {
    ...
    31: [function (e, t, r) {
      ...
      function f(e, t, r, i) {
        ...
        if ((s = e._events) ? (s.newListener && (e.emit("newListener", t, r.listener ? r.listener : r), s = e._events), a = s[t]) : (s = e._events = n(null), e._eventsCount = 0), a) {
          if ("function" == typeof a ? a = s[t] = i ? [r, a] : [a, r] : i ? a.unshift(r) : a.push(r), !a.warned && (o = l(e)) && o > 0 && a.length > o) {
            ...
            u.name = "MaxListenersExceededWarning", u.emitter = e, u.type = t, u.count = a.length, "object" == (typeof console === "undefined" ? "undefined" : _typeof(console)) && console.warn && console.warn("%s: %s", u.name, u.message);
          }
      ...
      a ? Object.defineProperty(s, "defaultMaxListeners", {
        ...
        switch (n = arguments.length) {
          case 1:
            !function (e, t, r) {
              if (t) e.call(r);else for (var n = e.length, i = b(e, n), o = 0; o < n; ++o) {
                i[o].call(r);
              }
            }(r, c, this);
            break;
          ...
          case 2:
            !function (e, t, r, n) {
              if (t) e.call(r, n);else for (var i = e.length, o = b(e, i), s = 0; s < i; ++s) {
                o[s].call(r, n);
              }
          ...
          case 3:
            !function (e, t, r, n, i) {
              if (t) e.call(r, n, i);else for (var o = e.length, s = b(e, o), a = 0; a < o; ++a) {
                s[a].call(r, n, i);
              }
          ...
          case 4:
            !function (e, t, r, n, i, o) {
              if (t) e.call(r, n, i, o);else for (var s = e.length, a = b(e, s), u = 0; u < s; ++u) {
                a[u].call(r, n, i, o);
              }
          ...
          default:
            ...
            !function (e, t, r, n) {
              if (t) e.apply(r, n);else for (var i = e.length, o = b(e, i), s = 0; s < i; ++s) {
                o[s].apply(r, n);
              }
            }(r, c, this, i);
        }
    ...
    36: [function (e, t, r) {
      (function (e) {
        (function () {
          ...
          for (var _e4 in r.types) {
            var _t11 = r.types[_e4];
            r.codes[_t11] = _e4;
          }
          ...
          for (var _e5 in r.properties) {
            var _t12 = r.properties[_e5];
            r.propertiesCodes[_t12] = _e5;
          }
          ...
          r.propertiesTypes = {
            ...
            pubrel: n("pubrel"),
            pubrec: n("pubrec")
          }, r.SUBACK_HEADER = e.from([r.codes.suback << r.CMD_SHIFT]), r.VERSION3 = e.from([3]), r.VERSION4 = e.from([4]), r.VERSION5 = e.from([5]), r.QOS = [0, 1, 2].map(function (t) {
            return e.from([t]);
          }), r.EMPTY = {
        ...
        (function () {
          ...
          var o = /*#__PURE__*/function (_i) {
            ...
            function o() {
              ...
              _this3 = _super.call(this), _this3._array = new Array(20), _this3._i = 0;
              return _this3;
            }
            ...
            _createClass(o, [{
              ...
              value: function concat() {
                ...
                for (i = 0; i < n.length && void 0 !== n[i]; i++) {
                  "string" != typeof n[i] ? t[i] = n[i].length : t[i] = r.byteLength(n[i]), e += t[i];
                }

                var s = r.allocUnsafe(e);

                for (i = 0; i < n.length && void 0 !== n[i]; i++) {
                  "string" != typeof n[i] ? (n[i].copy(s, o), o += t[i]) : (s.write(n[i], o), o += t[i]);
                }
    ...
    41: [function (e, t, r) {
      ...
      var u = /*#__PURE__*/function (_i2) {
        ...
        function u() {
          ...
          _this4 = _super2.call(this), _this4.parser = _this4.constructor.parser;
          return _this4;
        }
        ...
        _createClass(u, [{
          ...
          value: function parse(e) {
            for (this.error && this._resetState(), this._list.append(e), a("parse: current state: %s", this._states[this._stateCounter]); (-1 !== this.packet.length || this._list.length > 0) && this[this._states[this._stateCounter]]() && !this.error;) {
          ...
          value: function _parseConnect() {
            ...
            if (5 === o.protocolVersion) {
              var _e7 = this._parseProperties();

              Object.getOwnPropertyNames(_e7).length && (o.properties = _e7);
            }
            ...
            if (o.clientId = c, a("_parseConnect: packet.clientId: %s", o.clientId), i.will) {
              if (5 === o.protocolVersion) {
                var _e8 = this._parseProperties();

                Object.getOwnPropertyNames(_e8).length && (o.will.properties = _e8);
              }
          ...
          value: function _parseConnack() {
            ...
            if (5 === this.settings.protocolVersion) {
              var _t13 = this._parseProperties();

              Object.getOwnPropertyNames(_t13).length && (e.properties = _t13);
            }
          ...
          value: function _parsePublish() {
            ...
            if (!(e.qos > 0) || this._parseMessageId()) {
              if (5 === this.settings.protocolVersion) {
                var _t14 = this._parseProperties();

                Object.getOwnPropertyNames(_t14).length && (e.properties = _t14);
              }
          ...
          value: function _parseSubscribe() {
            ...
            if (e.subscriptions = [], this._parseMessageId()) {
              if (5 === this.settings.protocolVersion) {
                var _t15 = this._parseProperties();

                Object.getOwnPropertyNames(_t15).length && (e.properties = _t15);
              }
          ...
          value: function _parseSuback() {
            ...
            if (this.packet.granted = [], this._parseMessageId()) {
              if (5 === this.settings.protocolVersion) {
                var _t16 = this._parseProperties();

                Object.getOwnPropertyNames(_t16).length && (e.properties = _t16);
              }
          ...
          value: function _parseUnsubscribe() {
            ...
            if (e.unsubscriptions = [], this._parseMessageId()) {
              if (5 === this.settings.protocolVersion) {
                var _t17 = this._parseProperties();

                Object.getOwnPropertyNames(_t17).length && (e.properties = _t17);
              }

              for (; this._pos < e.length;) {
                var _t18 = this._parseString();

                if (null === _t18) return this._emitError(new Error("Cannot parse topic"));
                a("_parseUnsubscribe: push topic `%s` to unsubscriptions", _t18), e.unsubscriptions.push(_t18);
              }
            }
          }
        }, {
          ...
          value: function _parseUnsuback() {
            ...
            if (5 === this.settings.protocolVersion) {
              var _t19 = this._parseProperties();

              for (Object.getOwnPropertyNames(_t19).length && (e.properties = _t19), e.granted = []; this._pos < this.packet.length;) {
                this.packet.granted.push(this._list.readUInt8(this._pos++));
              }
            }
          }
          ...
          value: function _parseConfirmation() {
            ...
            if (this._parseMessageId(), 5 === this.settings.protocolVersion && (e.length > 2 && (e.reasonCode = this._parseByte(), a("_parseConfirmation: packet.reasonCode `%d`", e.reasonCode)), e.length > 3)) {
              var _t20 = this._parseProperties();

              Object.getOwnPropertyNames(_t20).length && (e.properties = _t20);
            }
          ...
          value: function _parseDisconnect() {
            ...
            if (a("_parseDisconnect"), 5 === this.settings.protocolVersion) {
              ...
              var _t21 = this._parseProperties();

              Object.getOwnPropertyNames(_t21).length && (e.properties = _t21);
            }
          ...
          value: function _parseProperties() {
            ...
            for (; this._pos < t;) {
              var _e9 = this._parseByte(),
                  _t22 = s.propertiesCodes[_e9];

              if (!_t22) return this._emitError(new Error("Unknown property")), !1;
              if ("userProperties" !== _t22) r[_t22] ? Array.isArray(r[_t22]) ? r[_t22].push(this._parseByType(s.propertiesTypes[_t22])) : (r[_t22] = [r[_t22]], r[_t22].push(this._parseByType(s.propertiesTypes[_t22]))) : r[_t22] = this._parseByType(s.propertiesTypes[_t22]);else {
                r[_t22] || (r[_t22] = Object.create(null));

                var _e10 = this._parseByType(s.propertiesTypes[_t22]);

                if (r[_t22][_e10.name]) {
                  if (Array.isArray(r[_t22][_e10.name])) r[_t22][_e10.name].push(_e10.value);else {
                    var _n3 = r[_t22][_e10.name];
                    r[_t22][_e10.name] = [_n3], r[_t22][_e10.name].push(_e10.value);
                  }
                } else r[_t22][_e10.name] = _e10.value;
              }
            }
      ...
      (function (r) {
        (function () {
            ...
            switch (u("generate called"), t.cork && (t.cork(), a(m, t)), g && (g = !1, f()), u("generate: packet.cmd: %s", e.cmd), e.cmd) {
              case "connect":
                return function (e, t, i) {
                  ...
                  if ("string" != typeof f && !r.isBuffer(f) || !f && 4 !== a || !f && !c) {
                  ...
                  if (u) {
                    if ("object" != _typeof(u)) return t.emit("error", new Error("Invalid will")), !1;
                  ...
                  t.write(n.CONNECT_HEADER), _(t, b), k(t, s), t.write(4 === a ? n.VERSION4 : 5 === a ? n.VERSION5 : n.VERSION3);
                  var S = 0;
                  S |= null != h ? n.USERNAME_MASK : 0, S |= null != p ? n.PASSWORD_MASK : 0, S |= u && u.retain ? n.WILL_RETAIN_MASK : 0, S |= u && u.qos ? u.qos << n.WILL_QOS_SHIFT : 0, S |= u ? n.WILL_FLAG_MASK : 0, S |= c ? n.CLEAN_SESSION_MASK : 0, t.write(r.from([S])), d(t, l), 5 === a && m.write();
                  k(t, f), u && (5 === a && y.write(), w(t, u.topic), k(t, u.payload));
                  null != h && k(t, h);
                  null != p && k(t, p);
                  return !0;
                }(e, t);
              ...
              case "connack":
                return function (e, t, i) {
                  ...
                  t.write(n.CONNACK_HEADER), _(t, l), t.write(a.sessionPresent ? n.SESSIONPRESENT_HEADER : o), t.write(r.from([u])), null != f && f.write();
                  return !0;
                }(e, t, s);
              ...
              case "publish":
                return function (e, t, o) {
                  ...
                  var s = o ? o.protocolVersion : 4,
                      ...
                      g = a.properties;
                  var b = 0;
                  if ("string" == typeof f) b += r.byteLength(f) + 2;else {
                    if (!r.isBuffer(f)) return t.emit("error", new Error("Invalid topic")), !1;
                    b += f.length + 2;
                  }
                  r.isBuffer(h) ? b += h.length : b += r.byteLength(h);
                  if (c && "number" != typeof p) return t.emit("error", new Error("Invalid messageId")), !1;
                  c && (b += 2);
                  var m = null;
                  ...
                  t.write(n.PUBLISH_HEADER[c][a.dup ? 1 : 0][l ? 1 : 0]), _(t, b), d(t, R(f)), t.write(f), c > 0 && d(t, p);
                  null != m && m.write();
                  return u("publish: payload: %o", h), t.write(h);
                }(e, t, s);
              ...
              case "pubcomp":
                return function (e, t, i) {
                  ...
                  if (5 === o && "object" == _typeof(h)) {
                    if (!(g = C(t, h, i, p))) return !1;
                    p += g.length;
                  }

                  t.write(n.ACKS[a][l][c][0]), _(t, p), d(t, u), 5 === o && t.write(r.from([f]));
                  null !== g && g.write();
                  return !0;
                }(e, t, s);
              ...
              case "subscribe":
                return function (e, t, i) {
                  ...
                  if ("object" != _typeof(l) || !l.length) return t.emit("error", new Error("Invalid subscriptions")), !1;

                  for (var _e11 = 0; _e11 < l.length; _e11 += 1) {
                    var _n4 = l[_e11].topic,
                        _i3 = l[_e11].qos;
                    if ("string" != typeof _n4) return t.emit("error", new Error("Invalid subscriptions - invalid topic")), !1;
                    if ("number" != typeof _i3) return t.emit("error", new Error("Invalid subscriptions - invalid qos")), !1;

                    if (5 === o) {
                      var _r7 = l[_e11].nl || !1;

                      if ("boolean" != typeof _r7) return t.emit("error", new Error("Invalid subscriptions - invalid No Local")), !1;

                      var _n5 = l[_e11].rap || !1;

                      if ("boolean" != typeof _n5) return t.emit("error", new Error("Invalid subscriptions - invalid Retain as Published")), !1;

                      var _i4 = l[_e11].rh || 0;

                      if ("number" != typeof _i4 || _i4 > 2) return t.emit("error", new Error("Invalid subscriptions - invalid Retain Handling")), !1;
                    }

                    h += r.byteLength(_n4) + 2 + 1;
                  }
                  ...
                  try {
                    for (_iterator.s(); !(_step = _iterator.n()).done;) {
                      ...
                      w(t, _i5), _l = n.SUBSCRIBE_OPTIONS_QOS[_s], 5 === o && (_l |= _a ? n.SUBSCRIBE_OPTIONS_NL : 0, _l |= _u ? n.SUBSCRIBE_OPTIONS_RAP : 0, _l |= _c ? n.SUBSCRIBE_OPTIONS_RH[_c] : 0), g = t.write(r.from([_l]));
                    }
                  } catch (err) {
                    _iterator.e(err);
                  } finally {
              ...
              case "suback":
                return function (e, t, i) {
                  ...
                  for (var _e13 = 0; _e13 < u.length; _e13 += 1) {
                    if ("number" != typeof u[_e13]) return t.emit("error", new Error("Invalid qos vector")), !1;
                    l += 1;
                  }
                  ...
                  t.write(n.SUBACK_HEADER), _(t, l), d(t, a), null !== f && f.write();
                  return t.write(r.from(u));
                }(e, t, s);
              ...
              case "unsubscribe":
                return function (e, t, i) {
                  ...
                  if ("number" != typeof a) return t.emit("error", new Error("Invalid messageId")), !1;
                  f += 2;
                  if ("object" != _typeof(c) || !c.length) return t.emit("error", new Error("Invalid unsubscriptions")), !1;

                  for (var _e14 = 0; _e14 < c.length; _e14 += 1) {
                    if ("string" != typeof c[_e14]) return t.emit("error", new Error("Invalid unsubscriptions")), !1;
                    f += r.byteLength(c[_e14]) + 2;
                  }
                  ...
                  for (var _e15 = 0; _e15 < c.length; _e15++) {
                    p = w(t, c[_e15]);
                  }
              ...
              case "unsuback":
                return function (e, t, i) {
                  ...
                  if (5 === o) {
                    if ("object" != _typeof(c) || !c.length) return t.emit("error", new Error("Invalid qos vector")), !1;

                    for (var _e16 = 0; _e16 < c.length; _e16 += 1) {
                      if ("number" != typeof c[_e16]) return t.emit("error", new Error("Invalid qos vector")), !1;
                      h += 1;
                    }
                  }
                  ...
                  t.write(n.ACKS[f][0][u][0]), _(t, h), d(t, a), null !== p && p.write();
                  5 === o && t.write(r.from(c));
                  return !0;
                }(e, t, s);
              ...
              case "disconnect":
                return function (e, t, i) {
                  ...
                  t.write(r.from([n.codes.disconnect << 4])), _(t, c), 5 === o && t.write(r.from([a]));
                  null !== l && l.write();
                  return !0;
                }(e, t, s);
              ...
              case "auth":
                return function (e, t, i) {
                  ...
                  var l = C(t, u, i, c);
                  if (!l) return !1;
                  c += l.length, t.write(r.from([n.codes.auth << 4])), _(t, c), t.write(r.from([a])), null !== l && l.write();
                  return !0;
                }(e, t, s);
          ...
          Object.defineProperty(b, "cacheNumbers", {
            ...
            set: function set(e) {
              e ? (c && 0 !== Object.keys(c).length || (g = !0), d = S) : (g = !1, d = E);
            }
          });
          var y = {};
          ...
          function _(e, t) {
            ...
            var r = y[t];
            return r || (r = h(t), t < 16384 && (y[t] = r)), u("writeVarByteInt: writing to stream: %o", r), e.write(r);
          }
          ...
          function I(e, t) {
            ...
            if (t) for (var _e17 in t) {
              var _r8 = 0,
                  _n6 = 0;
              var _s2 = t[_e17];
              if (Array.isArray(_s2)) for (var _t23 = 0; _t23 < _s2.length; _t23++) {
                if (!(_n6 = o(_e17, _s2[_t23]))) return !1;
                _r8 += _n6;
              } else {
                if (!(_n6 = o(_e17, _s2))) return !1;
                _r8 = _n6;
              }
              if (!_r8) return !1;
              i += _r8;
          ...
          function C(e, t, r, n) {
            ...
            if (o) for (; n + s.length > o;) {
              ...
              if (!_r9 || !t[_r9]) return !1;
              delete t[_r9], s = I(e, t);
            }
            return s;
          }
          ...
          function T(e, t, i) {
            switch (n.propertiesTypes[t]) {
              ...
              case "binary":
                e.write(r.from([n.properties[t]])), k(e, i);
                break;
          ...
          function x(e, t, r) {
            ...
            for (var _r10 in t) {
              if (Object.prototype.hasOwnProperty.call(t, _r10) && null !== t[_r10]) {
                var _n7 = t[_r10];
                if (Array.isArray(_n7)) for (var _t24 = 0; _t24 < _n7.length; _t24++) {
                  T(e, _r10, _n7[_t24]);
                } else T(e, _r10, _n7);
              }
            }
        ...
        (function () {
          !function (n) {
            ...
            function T(e, t) {
              var r = e.split("@"),
                  n = "";
              return r.length > 1 && (n = r[0] + "@", e = r[1]), n + C((e = e.replace(w, ".")).split("."), t).join(".");
            }
            ...
            function M(e, t, r) {
              ...
              for (e = r ? E(e / d) : e >> 1, e += E(e / t); e > S * h >> 1; n += l) {
                e = E(e / S);
              }

              return E(n + (S + 1) * e / (e + p));
            }
            ...
            function O(e) {
              ...
              for ((r = e.lastIndexOf(m)) < 0 && (r = 0), n = 0; n < r; ++n) {
                e.charCodeAt(n) >= 128 && I("not-basic"), _.push(e.charCodeAt(n));
              }

              for (i = r > 0 ? r + 1 : 0; i < w;) {
                for (o = v, s = 1, a = l; i >= w && I("invalid-input"), ((u = (y = e.charCodeAt(i++)) - 48 < 10 ? y - 22 : y - 65 < 26 ? y - 65 : y - 97 < 26 ? y - 97 : l) >= l || u > E((c - v) / s)) && I("overflow"), v += u * s, !(u < (p = a <= k ? f : a >= k + h ? h : a - k)); a += l) {
                  s > E(c / (d = l - p)) && I("overflow"), s *= d;
                }

                k = M(v - o, t = _.length + 1, 0 == o), E(v / t) > c - S && I("overflow"), S += E(v / t), v %= t, _.splice(v++, 0, S);
              }
            ...
            function P(e) {
              ...
              for (_ = (e = x(e)).length, t = b, r = 0, o = g, s = 0; s < _; ++s) {
                (y = e[s]) < 128 && C.push(k(y));
              }

              for (n = i = C.length, i && C.push(m); n < _;) {
                for (a = c, s = 0; s < _; ++s) {
                  (y = e[s]) >= t && y < a && (a = y);
                }

                for (a - t > E((c - r) / (w = n + 1)) && I("overflow"), r += (a - t) * w, t = a, s = 0; s < _; ++s) {
                  if ((y = e[s]) < t && ++r > c && I("overflow"), y == t) {
                    for (u = r, p = l; !(u < (d = p <= o ? f : p >= o + h ? h : p - o)); p += l) {
                      S = u - d, v = l - d, C.push(k(A(d + S % v, 0))), u = E(S / v);
                    }

                    C.push(k(A(u, 0))), o = M(r, w, n == i), r = 0, ++n;
                  }
                }
            ...
            if (a = {
              ...
              if (t.exports == i) o.exports = a;else for (u in a) {
      ...
      (function (r, n) {
        (function () {
          ...
          function I(t) {
            ...
            this._readableState = new k(t, this, r), this.readable = !0, t && ("function" == typeof t.read && (this._read = t.read), "function" == typeof t.destroy && (this._destroy = t.destroy)), s.call(this);
          }
          ...
          function C(e, t, r, n, i) {
            ...
            if (null === t) s.reading = !1, function (e, t) {
              ...
              var n;
              return r;
            }(s, t)), o) S(e, o);else if (s.objectMode || t && t.length > 0) {
              if ("string" == typeof t || s.objectMode || Object.getPrototypeOf(t) === a.prototype || (t = function (e) {
                return a.from(e);
              }(t)), n) s.endEmitted ? S(e, new v()) : T(e, s, t, !0);else if (s.ended) S(e, new _());else {
                if (s.destroyed) return !1;
                s.reading = !1, s.decoder && !r ? (t = s.decoder.write(t), s.objectMode || 0 !== t.length ? T(e, s, t, !1) : O(e, s)) : T(e, s, t, !1);
              }
          ...
          Object.defineProperty(I.prototype, "destroyed", {
            ...
            var r,
                n = this._readableState;
            return n.objectMode ? r = !0 : "string" == typeof e && ((t = t || n.defaultEncoding) !== n.encoding && (e = a.from(e, t), t = ""), r = !0), C(this, e, t, !1, r);
          ...
          function A(e) {
            var t = e._readableState;
            c("emitReadable", t.needReadable, t.emittedReadable), t.needReadable = !1, t.emittedReadable || (c("emitReadable", t.flowing), t.emittedReadable = !0, r.nextTick(M, e));
          }
          ...
          function q(e) {
            var t = e._readableState;
            c("endReadable", t.endEmitted), t.endEmitted || (t.ended = !0, r.nextTick(D, t, e));
          }
          ...
          I.prototype.read = function (e) {
            ...
            var t = this._readableState,
                r = e;
            if (0 !== e && (t.emittedReadable = !1), 0 === e && t.needReadable && ((0 !== t.highWaterMark ? t.length >= t.highWaterMark : t.length > 0) || t.ended)) return c("read: emitReadable", t.length, t.ended), 0 === t.length && t.ended ? q(this) : A(this), null;
            ...
            function h(t) {
              c("ondata");
              var r = e.write(t);
              c("dest.write", r), !1 === r && ((1 === i.pipesCount && i.pipes === e || i.pipesCount > 1 && -1 !== F(i.pipes, e)) && !f && (c("false write response, pause", i.awaitDrain), i.awaitDrain++), n.pause());
            }

            function p(t) {
              c("onerror", t), b(), e.removeListener("error", p), 0 === o(e, "error") && S(e, t);
            }
            ...
            function g() {
              c("onfinish"), e.removeListener("close", d), b();
            }
            ...
            }(e, "error", p), e.once("close", d), e.once("finish", g), e.emit("pipe", n), i.flowing || (c("pipe resume"), n.resume()), e;
            ...
            var n = s.prototype.on.call(this, e, t),
                i = this._readableState;
            return "data" === e ? (i.readableListening = this.listenerCount("readable") > 0, !1 !== i.flowing && this.resume()) : "readable" === e && (i.endEmitted || i.readableListening || (i.readableListening = i.needReadable = !0, i.flowing = !1, i.emittedReadable = !1, c("on readable", i.length, i.reading), i.length ? A(this) : i.reading || r.nextTick(L, this))), n;
      ...
      (function (r, n) {
        (function () {
          ...
          function I(t) {
            ...
            if (!r && !l.call(I, this)) return new I(t);
            this._writableState = new k(t, this, r), this.writable = !0, t && ("function" == typeof t.write && (this._write = t.write), "function" == typeof t.writev && (this._writev = t.writev), "function" == typeof t.destroy && (this._destroy = t.destroy), "function" == typeof t.final && (this._final = t.final)), a.call(this);
          }
          ...
          e("inherits")(I, a), k.prototype.getBuffer = function () {
          ...
          }(), "function" == typeof Symbol && Symbol.hasInstance && "function" == typeof Function.prototype[Symbol.hasInstance] ? (l = Function.prototype[Symbol.hasInstance], Object.defineProperty(I, Symbol.hasInstance, {
            value: function value(e) {
              return !!l.call(this, e) || this === I && e && e._writableState instanceof k;
            }
          })) : l = function l(e) {
            return e instanceof this;
            ...
            var i,
                ...
                s = !1,
                a = !o.objectMode && (i = e, u.isBuffer(i) || i instanceof c);
    ...
    60: [function (e, t, r) {
      ...
      t.exports = function e(t, r, o) {
        ...
        return function (e) {
          return e.setHeader && "function" == typeof e.abort;
        }(t) ? (t.on("complete", l), t.on("abort", d), t.req ? g() : t.on("request", g)) : a && !t._writableState && (t.on("end", u), t.on("close", u)), t.on("end", h), t.on("finish", l), !1 !== r.error && t.on("error", p), t.on("close", d), function () {
    ...
    71: [function (e, t, r) {
      ...
      o.prototype.parse = function (e, t, r) {
        ...
        if (r || v || _.match(/^\/\/[^@\/]+@[^@\/]+/)) {
          ...
          !E || v && b[v] || (_ = _.substr(2), this.slashes = !0);
        }

        if (!b[v] && (E || v && !m[v])) {
          for (var k, I, C = -1, T = 0; T < h.length; T++) {
            -1 !== (x = _.indexOf(h[T])) && (-1 === C || x < C) && (C = x);
          }

          -1 !== (I = -1 === C ? _.lastIndexOf("@") : _.lastIndexOf("@", C)) && (k = _.slice(0, I), _ = _.slice(I + 1), this.auth = decodeURIComponent(k)), C = -1;

          for (T = 0; T < f.length; T++) {
            var x;
            -1 !== (x = _.indexOf(f[T])) && (-1 === C || x < C) && (C = x);
          }

          -1 === C && (C = _.length), this.host = _.slice(0, C), _ = _.slice(C), this.parseHost(), this.hostname = this.hostname || "";
          var R = "[" === this.hostname[0] && "]" === this.hostname[this.hostname.length - 1];
          if (!R) for (var A = this.hostname.split(/\./), M = (T = 0, A.length); T < M; T++) {
            var O = A[T];

            if (O && !O.match(p)) {
              for (var P = "", B = 0, L = O.length; B < L; B++) {
                O.charCodeAt(B) > 127 ? P += "x" : P += O[B];
              }
        ...
        if (!g[S]) for (T = 0, M = l.length; T < M; T++) {
          var F = l[T];
        ...
        if (e.protocol && e.protocol !== r.protocol) {
          ...
          if (r.protocol = e.protocol, e.host || b[e.protocol]) r.pathname = e.pathname;else {
        ...
        var _ = r.pathname && "/" === r.pathname.charAt(0),
            ...
            k = (d = e.pathname && e.pathname.split("/") || [], r.protocol && !m[r.protocol]);

        if (k && (r.hostname = "", r.port = null, r.host && ("" === E[0] ? E[0] = r.host : E.unshift(r.host)), r.host = "", e.protocol && (e.hostname = null, e.port = null, e.host && ("" === d[0] ? d[0] = e.host : d.unshift(e.host)), e.host = null), v = v && ("" === d[0] || "" === E[0])), w) r.host = e.host || "" === e.host ? e.host : r.host, r.hostname = e.hostname || "" === e.hostname ? e.hostname : r.hostname, r.search = e.search, r.query = e.query, E = d;else if (d.length) E || (E = []), E.pop(), E = E.concat(d), r.search = e.search, r.query = e.query;else if (!i.isNullOrUndefined(e.search)) {
          if (k) r.hostname = r.host = E.shift(), (R = !!(r.host && r.host.indexOf("@") > 0) && r.host.split("@")) && (r.auth = R.shift(), r.host = r.hostname = R.shift());
        ...
        for (var I = E.slice(-1)[0], C = (r.host || e.host || E.length > 1) && ("." === I || ".." === I) || "" === I, T = 0, x = E.length; x >= 0; x--) {
          "." === (I = E[x]) ? E.splice(x, 1) : ".." === I ? (E.splice(x, 1), T++) : T && (E.splice(x, 1), T--);
        }
        ...
        k && (r.hostname = r.host = A ? "" : E.length ? E.shift() : "", (R = !!(r.host && r.host.indexOf("@") > 0) && r.host.split("@")) && (r.auth = R.shift(), r.host = r.hostname = R.shift()));
        return (v = v || r.host && E.length) && !A && E.unshift(""), E.length ? r.pathname = E.join("/") : (r.pathname = null, r.path = null), i.isNull(r.pathname) && i.isNull(r.search) || (r.path = (r.pathname ? r.pathname : "") + (r.search ? r.search : "")), r.auth = e.auth || r.auth, r.slashes = r.slashes || e.slashes, r.href = r.format(), r;
...
},{}],"../../../../../../../../../../home/smercado/.npm/_npx/226768/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "35935" + '/');
...
},{}]},{},["../../../../../../../../../../home/smercado/.npm/_npx/226768/lib/node_modules/parcel/src/builtins/hmr-runtime.js","js/mqtt.min.js"], null)
//# sourceMappingURL=/mqtt.min.067f63c3.js.map